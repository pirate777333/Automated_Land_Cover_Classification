...
def RasporediKlasificirano(MultiBandNiz2, mndwi_original, mndwi_klasificirano, ndvi_original, ndbi_original, bsi_original, brojkanala=BrKanala, Xd=Xsize, Yd=Ysize):
    ...
    if g>0:
        ...
        ndvi_preclassified_reshaped = ndvi_preclassified.reshape(Xd,Yd)
        dataset_ndvi_original.GetRasterBand(1).WriteArray(ndvi_preclassified_reshaped)
        ndbi_preclassified_reshaped = ndbi_preclassified.reshape(Xd,Yd)
        dataset_ndbi_original.GetRasterBand(1).WriteArray(ndbi_preclassified_reshaped)
        bsi_preclassified_reshaped = bsi_preclassified.reshape(Xd,Yd)
...
voda, MultiBandDATA2 = RasporediKlasificirano(MultiBandDATA, mjesto_za_mndwi_copy, mjesto_za_KlasifikacijuMNDWI, mjesto_za_ndvi_copy, mjesto_za_ndbi_copy, mjesto_za_bsi_copy)
...
visokav, niskav, MultiBandDATA3 = RasporediKlasificirano2(MultiBandDATA2, mjesto_za_ndvi_copy, mjesto_za_KlasifikacijuNDVI, mjesto_za_ndbi_copy, mjesto_za_bsi_copy)
...
gola1, MultiBandDATA4 = Rasporediklasificirano3(MultiBandDATA3, mjesto_za_ndbi_copy, mjesto_za_KlasifikacijuNDBI, mjesto_za_bsi_copy)
...
def Rasporediklasificirano4(bsi_original, bsi_klasificirano, brojkanala=BrKanala, Xd=Xsize, Yd=Ysize):
    ...
    izgradena_klasa2 = np.where((band_dataset_bsi_klasificirano==k[0])|(band_dataset_bsi_klasificirano==k[1])|(band_dataset_bsi_klasificirano==k[2]),5,-9999)#
...
s5 = s5.reshape(Xsize, Ysize)

mjesto_za_final_klasifikaciju = "./"+folder_Cl+"/FinalKlasificirano0989701.tif"
