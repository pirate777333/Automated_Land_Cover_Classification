...
KMeansKlasifikacija(MultiBandDATA, mjesto_za_mndwi, mjesto_za_KlasifikacijuMNDWI, 4)
...
voda, MultiBandDATA2 = RasporediKlasificirano(MultiBandDATA, mjesto_za_mndwi, mjesto_za_KlasifikacijuMNDWI, mjesto_za_ndvi, mjesto_za_ndbi, mjesto_za_bsi)

KMeansKlasifikacija(MultiBandDATA2, mjesto_za_ndvi, mjesto_za_KlasifikacijuNDVI, 5)
...
visokav, niskav, MultiBandDATA3 = RasporediKlasificirano2(MultiBandDATA2, mjesto_za_ndvi, mjesto_za_KlasifikacijuNDVI, mjesto_za_ndbi, mjesto_za_bsi)

KMeansKlasifikacija(MultiBandDATA3, mjesto_za_ndbi, mjesto_za_KlasifikacijuNDBI, 7)
...
gola1, MultiBandDATA4 = Rasporediklasificirano3(MultiBandDATA3, mjesto_za_ndbi, mjesto_za_KlasifikacijuNDBI, mjesto_za_bsi)

KMeansKlasifikacija(MultiBandDATA4, mjesto_za_bsi, mjesto_za_KlasifikacijuBSI, 6)
...
def Rasporediklasificirano4(bsi_original, bsi_klasificirano, brojkanala=BrKanala, Xd=Xsize, Yd=Ysize):
    ...
    izgradena_klasa2 = np.where((band_dataset_bsi_klasificirano==k[0])|(band_dataset_bsi_klasificirano==k[1])|(band_dataset_bsi_klasificirano==k[2])|(band_dataset_bsi_klasificirano==k[3]),5,-9999)# |(band_dataset_bsi_klasificirano==k[2])
...
izgradena2, tlo = Rasporediklasificirano4(mjesto_za_bsi, mjesto_za_KlasifikacijuBSI)
...
mjesto_za_final_klasifikaciju = "./"+folder_Cl+"/FinalKlasificirano4576.tif"
